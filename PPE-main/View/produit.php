...
<!--
  produit.php est un HTML structurant le tableau permettant d'afficher
  la liste des produits : l'id du produit, le nom du produit, la localisation du produit,
  ainsi que la quantité du produit.
