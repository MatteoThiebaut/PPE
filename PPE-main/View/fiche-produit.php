...
<!--
  fiche-produit.php est un HTML structurant le tableau permettant d'afficher
  le détail des produits : l'id, le nom, la référence, le Fournisseur, le coût,
  le prix unitaire, la description aisni que la quantité du produit concerné
  Cet HTML est relié à un CSS pour le désign.
-->
